...
@router.get("/", response_model=List[schemas.DriverResponse], summary="List all drivers")
def list_drivers(
    skip: int = 0,
    limit: int = 100,
...
@router.get("/{driver_id}", response_model=schemas.DriverResponse, summary="Get a driver")
def get_driver(
...
@router.patch("/{driver_id}", response_model=schemas.DriverResponse, summary="Update a driver")
def update_driver(
